    ...
    <>
      ...
      >
        <div className="items-center gap-x-8 px-4 max-w-screen-xl mx-auto md:flex md:px-8">
          ...
          <AnimatePresence>
            {((state && !isDesktop) || isDesktop || isTablet) && (
              <motion.div
                                      ...
                                      {dropdownItem.navs?.map(
                                        (
                                          ...
                                          <li key={idx} className="group">
                                            ...
                                            >
                                              <div className="w-12 h-12 rounded-full bg-indigo-50 text-indigo-600 flex items-center justify-center duration-200 group-hover:bg-indigo-600 group-hover:text-white md:w-14 md:h-14">
                                                {navItem.icon}
                                              </div>
                                              <div>
                  ...
                  <div className="flex-1 items-center justify-end gap-x-6 space-y-3 md:flex md:space-y-0">
                    ...
                    <li>
                      <Link
                        ...
                        className="block py-3 px-4 font-medium text-center duration-200 text-white bg-indigo-600 hover:bg-indigo-500 active:bg-indigo-700 active:shadow-none rounded-lg shadow md:inline"
                      >
